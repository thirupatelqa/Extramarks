package com.extramarks.website.utilities;
...
//			style.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
     ...
     public int testCaseColumns(String sheetname,String TestCase){	
			...
			int testcasecolumns=row.getLastCellNum();
		...
		public HashMap<String,String> gettestdata(String sheetname,int testCaseRowNumber) {
			 ...
			 for(int i=1;i<=ColCount;i++) {				 
				  ...
				  if(actualrowdata.equalsIgnoreCase("Mr.")) {
					  actualrowdata=getCellData(sheetname,i,testCaseRowNumber);
				  }else if(actualrowdata.indexOf(".")>0) {
					  String[] data=getCellData(sheetname,i,testCaseRowNumber).replace(".", "_").split("_");
					  actualrowdata=data[0];
					  //System.out.println("actualrowdata1 : "+ actualrowdata);
				  }else {
					  actualrowdata=getCellData(sheetname,i,testCaseRowNumber);
					  //System.out.println("actualrowdata2 : "+ actualrowdata);
				  }
		...
		public void setCellDataValue(String sheetName, String rowHeader, String  columnHeader, String data, int header) throws IOException, InterruptedException {
		...
		public void setCellDataThroughStaticRow$Col(String sheetName, int rowNum, int cellNum, String data) throws IOException, InterruptedException {
		...
		// method for press f2 and Enter in the excel
		public void xcellCompareMethod(String sheetName) throws IOException, AWTException, InterruptedException {
		...
		for (int rowNum = 3; rowNum < 4; rowNum++) {
			...
			for (int cellNum = 25; cellNum < 35; cellNum++) {

				cell = row.getCell(cellNum);
				
				cell.setCellValue("=EXACT(TRIM(B4),TRIM(N4))");
