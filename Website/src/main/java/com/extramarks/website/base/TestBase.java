...
public class TestBase {
	...
	public TestBase(){
		try {
			prop = new Properties();
			FileInputStream fis;
			fis = new FileInputStream("E:/selenium_project"
					+ "/Website/src/main/java/com/extramarks/website/properties/config.properties");
			prop.load(fis);
		} 
	...
	public void launchBrowser(){
		...
		try{
			if(browserName.equals("chrome")){
				System.setProperty("webdriver.chrome.driver", "E:/selenium_project"
						+ "/Website/src/main/java/com/extramarks/website/utilities/chromedriver.exe");
